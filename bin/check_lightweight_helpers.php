...
if (update_parse_sha256_text($hash . '  v4.5.1.zip', 'v4.5.1.zip', 'v4.5.1') !== $hash) {
	$errors[] = 'update_parse_sha256_text did not parse targeted checksum lines';
}
if (update_parse_sha256_text(str_repeat('b', 64) . '  other.zip', 'v4.5.1.zip', 'v4.5.1') !== '') {
