...
$detectSteps->invoke($command) === array()
	|| fail_upgrade_config('an aligned 4.5.1 config must remain a true no-op');
...
isset($updates['static_version']) && $updates['static_version'] === '?v=4.5.1'
...
$replacement = '<?php return array("version"=>"4.5.1");';
