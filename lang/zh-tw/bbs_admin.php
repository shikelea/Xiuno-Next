...
return array(
	...
	'locale_unavailable'=>'所選語言不可用或必需的語言資源不完整。',
	...
	'plugin_safe_mode'=>'應用插件安全模式',
	'plugin_safe_mode_marker_path'=>'標記文件路徑',
	'plugin_safe_mode_log_path'=>'安全模式日誌路徑',
	'plugin_safe_mode_latest_error'=>'最近一次插件或編譯執行階段錯誤',
	'plugin_safe_mode_exit'=>'退出插件安全模式',
	'plugin_safe_mode_exit_success'=>'安全模式標記已清除，下一次請求將恢復正常插件載入。',
	'plugin_safe_mode_exit_locked'=>'另一個安全模式操作正在執行，請稍後重試。',
	'plugin_safe_mode_exit_clear_failed'=>'一個或多個安全模式標記無法清除，請檢查頁面顯示的路徑和文件權限；插件仍保持停用。',
	'plugin_safe_mode_exit_unlock_failed'=>'安全模式標記已清除，但操作鎖釋放失敗，請重新整理並確認狀態後再繼續。',
	...
	// 插件
	'plugin_dir'=>'插件目錄名',
	'plugin_dir_invalid'=>'插件目錄名無效。請使用 1 至 64 位字母、數字、底線或連字號，且首字元不能是連字號。',
	...
	'plugin_not_installed'=>'插件尚未安裝。',
	'plugin_setting_path_invalid'=>'插件設置頁面路徑無效。',
	'plugin_package_path_invalid'=>'插件包路徑不可用或不安全，請確認它是可讀的本機真實目錄且不是符號連結。',
	'plugin_setting_no_output'=>'插件設置頁面沒有輸出內容。該插件可能沒有可配置項，或其設置介面與目前版本不相容。',
	...
	'plugin_being_dependent_cant_disable'=>'不能禁用{name}，以下插件依賴它：{s}，',
	...
	'plugin_state_unavailable'=>'插件狀態暫時不可用，請檢查運行時鎖目錄後重試。',
	'plugin_state_storage_readonly'=>'插件狀態存儲 {file} 為只讀。不可變部署中無法安裝、啟用、禁用或卸載插件；設置頁面仍可使用。',
	'plugin_state_storage_readonly_short'=>'插件狀態為只讀',
