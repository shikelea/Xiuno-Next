...
function haya_post_like_get_pids($postlist) {
    global $haya_post_like_config, $thread, $uid;
    if (!isset($haya_post_like_config) || !function_exists('haya_post_like_find_by_pids_and_uid')) {
        return [];
    }
