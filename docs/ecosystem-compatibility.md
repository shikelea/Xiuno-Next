...
- `issue_types`: high-level groups such as `php8`, `bs4`, `csrf`, and `theme`.
...
The 2026-05-28 scan covered 58 local samples, including 21 theme-like samples. It found 593 compatibility signals and 22 PHP lint errors. The normalized matrix currently classifies 10 samples as blocked by PHP lint, 10 as needing package patches, 27 as needing core/theme validation, and 11 as likely compatible. Most findings fell into BS4 to BS5 compatibility and PHP 8 migration, followed by theme boundary and CSRF/POST behavior.
