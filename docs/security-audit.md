...
- `bin/check_frontend_security.php`, `bin/check_plugin_dependency_status.php`, `bin/check_plugin_task_safety.php`, and `bin/check_plugin_package_rollback.php` guard these contracts in CI.
