...
- `bin/check_frontend_security.php`, `bin/check_plugin_dependency_status.php`, `bin/check_plugin_task_safety.php`, `bin/check_plugin_package_rollback.php`, `bin/check_update_task_safety.php`, `bin/check_install_safety.php`, and `bin/check_cli_upgrade_safety.php` guard these contracts in CI.
